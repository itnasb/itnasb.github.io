...
var hljs = (function () {
  ...
  */
  ...
  // - other escape sequences, so we don't misparse escape sequences as
  //   interesting elements
  // - non-matching or lookahead parentheses, which don't capture. These
  //   follow the '(' with a '?'.
    ...
    function _highlight(languageName, codeToHighlight, ignoreIllegals, continuation) {
        ...
        while (match) {
          ...
          if (data) {
            ...
            if (kind.startsWith("_")) {
              // _ implied for relevance only, don't highlight
      ...
      function processLexeme(textBeforeMatch, match) {
        ...
        if (match.type === "begin") {
          ...
          // illegal match, we don't continue processing
          /** @type {AnnotatedError} */
...
/*! `apache` grammar compiled for Highlight.js 11.10.0 */
  ...
  function cPlusPlus(hljs) {
    ...
    const FUNCTION_DECLARATION = {
      ...
      contains: [
        ...
        // needed because we don't have look-behind on the below rule
  ...
  */
  ...
  function json(hljs) {
    ...
    // - as illegal indicating that despite looking like JSON we don't truly have
